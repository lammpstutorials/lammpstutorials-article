...
it \textit{input.lammps}. Open \textit{input.lammps} using the GUI, and copy
...
the following line into the \textit{input.lammps} file:
{\normalsize \begin{verbatim}
include parm.lammps
\end{verbatim}}
...
\textit{fix setforce}. Add the following lines in the \textit{input.lammps} file,
...
\textit{input.lammps}. Type into \textit{input.lammps}:
{\normalsize \begin{verbatim}
# Initialisation
variable T equal 300
...
the following lines into \textit{input.lammps}:
{\normalsize \begin{verbatim}
# System definition
...
the \textit{breakable-bonds/} folder. The rest of the \textit{input.lammps} is
...
\textit{input.lammps} with LAMMPS, you can see that the temperature deviates
