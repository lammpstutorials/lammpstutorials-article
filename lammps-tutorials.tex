...
\lmpcmd{ewald} command defines the long-range solver for the Coulomb
...
group H2O type OW HW
\end{lstlisting}
After reading the data file and defining the \lmpcmd{h2omol} molecule from the \flecmd{H2O.mol}
...
$3.822~\mathrm{\AA{}}$ was chosen to create a Weeks-Chandler-Andersen (WCA) potential,
