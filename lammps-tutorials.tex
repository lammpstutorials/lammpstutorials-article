...
The second line, \lmpcmd{dimension 3}, specifies that the simulation is conducted
...
A screenshot of this context menu is shown in figure~\ref{fig:GUI-1}.
...
and update the chart in real time (see Figure~\ref{fig:chart-log}).  This run executes quickly (depending
...
negative value (Figures~\ref{fig:chart-log} and \ref{fig:evolution-energy}\,a).
