...
\caption{Calculated potential $-R T \ln(\rho/\rho_\mathrm{bulk})$ [Eq.\,\eqref{eq:G}] (blue line) compared to the imposed potential [Eq.\,\eqref{eq:U}] (dark line).}
