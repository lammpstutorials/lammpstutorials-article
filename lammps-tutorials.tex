...
\caption{(a) Potential energy ($p_\text{e}$) of the binary mixture
as a function of the step during energy minimization in \hyperref[lennard-jones-label]{Tutorial 1}.
(b) Potential energy ($p_\text{e}$) as a function of time during
molecular dynamics in the NVT ensemble.  (c) Kinetic energy
($k_\text{e}$) during energy minimization.  (d) Kinetic energy
($k_\text{e}$) during molecular dynamics.}
