...
\begin{abstract}
Highly powerful and open-source molecular simulation codes enable users to launch molecular simulations without personally implementing inter-particle interactions or integrating Newton's equations of motion. However, while launching and analyzing a molecular simulation is now accessible to all, the exploitation of these open-source codes can be hindered by their numerous options and associated pitfalls
