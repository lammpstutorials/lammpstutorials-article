...
(Figs.~\ref{fig:chart-log} and~\ref{fig:evolution-energy}\,a).  Note that $E = U$ 
during energy minization, as the kinetic energy $K = 0$.  The
...
energy $E$ is initially increasing with the deformation.  When
