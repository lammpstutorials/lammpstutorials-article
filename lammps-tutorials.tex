...
\lstset{
  basicstyle=\small\color{command},  % Default font, small size, and custom color
  numbers=none, % No number on the side
  frame=single, % Enable a frame
  framerule=0.0pt, % Invisible frame frame
  framesep=5pt, % Space between text and frame
  backgroundcolor=\color{listing}, % Set background color
  xleftmargin=5pt, % Extra left margin for spacing
  xrightmargin=5pt, % Extra right margin for spacing
}

% make \emph{} use underline instead of italic
\renewcommand{\emph}[1]{\underline{#1}}
% for LAMMPS commands
\newcommand{\lmpcmd}[1]{%
  \hspace{0pt}\colorbox{listing}{\textcolor{command}{\texttt{#1}}}\hspace{0pt}%
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
