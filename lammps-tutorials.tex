...
% S.G.: Using the LAMMPS-GUI that came with the 29Aug2024 version, all spheres
% have the same size by default. Is it expected behavior?
...
of the $t$. b) Kinetic energy ($k_\text{e}$) as a function of time $t$.}
...
% S.G.: I don't see the option "Copy dump image command" using the LAMMPS-GUI from the 29Aug2024 version.
