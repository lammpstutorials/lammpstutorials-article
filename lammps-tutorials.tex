...
energy reaches a plateau.  The generated file
...
run 200000
\end{lstlisting}
Here, a bin size of $1\,\text{\AA{}}$ is used for the density profiles generated
...
profiles of the fluid are plotted in
Figs.~\ref{fig:NANOSHEAR-velocity}-\ref{fig:NANOSHEAR-density}.  As expected for such Couette flow geometry, the fluid velocity increases linearly along $z$.
