...
\item EXTRA-DUMP
\end{itemize}
In addition, to visualize the atoms trajectories, the version 1.9.3 of VMD will be used \cite{humphrey1996vmd}. {\color{red}If you prefer, feel free to use an alternative visualization software like Ovito.} Finally a graph plotting tool is required. To plot the results from the simulations, the version 3.5.2 of Matplotlib Pyplot is used together with the version 3.11.4 of Python \cite{van1995python, hunter2007Matplotlib}, but any plotting tool can be used. 
