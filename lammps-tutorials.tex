...
fix mylgv all langevin 119.8 119.8 500 30917
\end{lstlisting}
And then let us perform a short equilibration
...
step of \hyperref[umbrella-sampling-label]{Tutorial 7}, with atoms of type 1 in cyan and the atom
of type 2 in red. Only the atom of type 2 explores the central part of the box,
\lmpcmd{mymes}, due to the additional biasing potential $V$. Here,
$U_0 = 2.38~\text{kcal/mol}$, $\delta = 1.0~\mathrm{\AA{}}$,
