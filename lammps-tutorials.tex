...
Å, time in femtoseconds, and energies in kcal/mole.  With the \lmpcmd{atom\_style full},
...
generate the probability distribution of the charge, $P(q)$ (see Fig.~\ref{fig:SIO-distribution}\,a).
