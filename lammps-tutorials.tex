...
\usepackage{csquotes}
% without using the package here, \hyperref links have no effect.
\usepackage{hyperref}
...
\author[2]{\textcolor{blue}{Cecilia M.~S.~Alvares}}
\affil[2]{\textcolor{blue}{Department of Chemistry, University of Warwick, Coventry CV4 7AL, United Kingdom}}
\orcid{Cecilia M.~S.~Alvares}{\textcolor{blue}{0009-0007-6237-6512}}
...
% this reads better as a single note.
\begin{note}
...
for publication (see for instance Ref.~\citenum{grossfield2009quantifying}).}
\end{note}
...
and is approximately $2.7\,\mathrm{kcal/mol/\AA{}}$. % in magnitude.
...
\begin{note}
{\color{blue}In the \lmpcmd{pair\_coeff} command, the first two asterisks
\lmpcmd{* *} indicate that the parameters apply to all atom types in the simulation.}
\end{note}
...
%$\rho/\rho_\mathrm{bulk}$, assuming the system behaves as an ideal gas)
...
for \href{https://lammpstutorials.github.io}{lammpstutorials.github.io}.  {\color{blue}C.A. tested
