...
\newcommand{\flrcmd}[1]{\textcolor{command}{\texttt{#1}}} % folder
\newcommand{\flecmd}[1]{\textcolor{command}{\texttt{#1}}} % files name 
\newcommand{\dwlcmd}[1]{\textcolor{download}{\texttt{#1}}} % downloadable files
...
% S.G.: remove "folder names" if all folders are removed
% S.G.: remove "Section titles" as well?
