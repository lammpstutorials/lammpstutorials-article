...
\end{verbatim}}
With \textit{run 0}, the simulation will run for 0 steps, which is enough for creating the system and saving the final state. The \textit{write$\_$data} creates a file called \textit{system.data} containing all the information required to restart the
