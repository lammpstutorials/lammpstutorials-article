...
The tutorials that are proposed in this article aim to reduce the learning curve and help the users perform accurate and reliable molecular simulations using LAMMPS.

\subsection{Scope}

This suite of tutorials is made of seven tutorials that are ordered by increasing difficulty. The first tutorial, \hyperref[lennard-jones-label]{Lennard Jones fluid}, is meant for LAMMPS absolute beginners and requires no prior knowledge of LAMMPS. The complexity of the simulations is then progressively increased during the following tutorials, and not all commands will be re-described in depth.
