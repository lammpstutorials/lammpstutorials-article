...
% AK: we should intoduce advanced visualization/plotting when beneficial and then use the LAMMPS GUI only to edit the input, run LAMMPS and visually validate initial geometry.
%
