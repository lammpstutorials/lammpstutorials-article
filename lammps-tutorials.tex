...
The commands that must be copied and pasted into LAMMPS input files or the terminal are written in a {\small \verb+verbatim+} environment. File and folder names are written in \textit{italic}.
