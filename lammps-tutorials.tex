...
charge distribution slightly differs from the previously calculated. In my case,
no new species were formed during the simulation, as can be seen from the
\textit{species.log} file:
{\normalsize \begin{verbatim}
...
every step:
% S.G. can we avoid the loop? or just may be remove the dump image here...
{\normalsize \begin{verbatim}
fix mynvt all nvt temp 300.0 300.0 100
timestep 0.5
...
A third atom of color white and 
...
# Timestep   No_Moles No_Specs Si192O384H20
  20000      1        1        1
\end{verbatim}}
At the end of the simulation, hydroxyl groups can be seen at the interfaces
