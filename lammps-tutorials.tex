...
Run \textit{input.md.lammps} using LAMMPS. Open the \textit{dump.md.lammpstrj} file using VMD to observe the mixing of the two populations over time (Fig.\,\ref{fig:evolution-population}). From the generated \textit{.dat} file, one can plot
