...
The commands that must be written in a LAMMPS input file, as well as the commands that must be written in the terminal to launch LAMMPS and VMD are written in a \verb+verbatim+ environment. File and folder names are written in \textit{italic}.
