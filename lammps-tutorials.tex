...
input files is illustrated through creation of a simple, atomic
...
a simple MD simulation in the microcanonical (NVE) and canonical (NVT)
ensembles.  This tutorial also illustrates the basic use of the LAMMPS
graphical user interface (LAMMPS--GUI) for writing input files, running
simulations, and visualizing results.
...
refer to text books like \textit{Understanding Molecular Simulation} by
...
LAMMPS versions).  Thus it generally be possible to follow this tutorial
...
\item Customization through preferences dialogs
\end{itemize}
